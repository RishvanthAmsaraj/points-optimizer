...
const transferRates: TransferRateSeed[] = [
  ...
  { from_program: "Amex Membership Rewards", to_program: "Hilton Honors", ratio: 1.00, is_reversible: false, typical_timing: "Instant", minimum_transfer: 1000, bonus_multiplier: 2.00 },
